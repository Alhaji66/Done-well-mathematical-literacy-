...
export const resources: Resource[] = [
  ...
  {
    id: 'res-math-lb-12',
    title: 'Mathematics Learner Book — Grade 12',
    type: 'Learner Book',
    grade: 12,
    subjectId: 'mathematics',
    pages: 240,
    updated: '2026 edition',
    description: 'Full CAPS-aligned learner book covering Algebra, Functions, Trigonometry, Analytical Geometry, Statistics, Calculus and Finance & Growth.',
  },
  {
    id: 'res-math-wb-12',
    title: 'Mathematics Workbook — Grade 12',
    type: 'Workbook',
    grade: 12,
    subjectId: 'mathematics',
    pages: 128,
    updated: '2026 edition',
    description: 'Graded practice exercises per topic, from routine drill questions to exam-style problems.',
  },
  {
    id: 'res-math-tg-12',
    title: 'Teacher Guide — Grade 12 Mathematics',
    type: 'Teacher Guide',
    grade: 12,
    subjectId: 'mathematics',
    pages: 160,
    updated: '2026 edition',
    description: 'Lesson pacing, worked solutions and full memoranda for the Grade 12 Learner Book.',
  },
  {
    id: 'res-math-test-fun-12',
    title: 'Functions & Graphs Topic Test — Grade 12',
    type: 'Test',
    grade: 12,
    subjectId: 'mathematics',
    topicId: 'math-functions',
    updated: 'Term 1',
    description: '45-minute topic test covering linear, quadratic, exponential and hyperbolic functions. 40 marks.',
  },
  {
    id: 'res-math-memo-fun-12',
    title: 'Functions & Graphs Topic Test Memo — Grade 12',
    type: 'Memo',
    grade: 12,
    subjectId: 'mathematics',
    topicId: 'math-functions',
    updated: 'Term 1',
    description: 'Full marking memorandum with method marks indicated for the Functions & Graphs topic test.',
  },
  {
    id: 'res-math-lb-11',
    title: 'Mathematics Learner Book — Grade 11',
    type: 'Learner Book',
    grade: 11,
    subjectId: 'mathematics',
    pages: 224,
    updated: '2026 edition',
    description: 'Full CAPS-aligned learner book for Grade 11 Mathematics.',
  },
  {
    id: 'res-math-wb-11',
    title: 'Mathematics Workbook — Grade 11',
    type: 'Workbook',
    grade: 11,
    subjectId: 'mathematics',
    pages: 112,
  ...
  {
    id: 'res-math-tg-11',
    title: 'Teacher Guide — Grade 11 Mathematics',
    type: 'Teacher Guide',
    grade: 11,
    subjectId: 'mathematics',
    pages: 148,
  ...
  {
    id: 'res-math-lb-10',
    title: 'Mathematics Learner Book — Grade 10',
    type: 'Learner Book',
    grade: 10,
    subjectId: 'mathematics',
    pages: 200,
    updated: '2026 edition',
    description: 'Foundation-building learner book covering the core Grade 10 Mathematics curriculum.',
  },
  {
    id: 'res-math-wb-10',
    title: 'Mathematics Workbook — Grade 10',
    type: 'Workbook',
    grade: 10,
    subjectId: 'mathematics',
    pages: 96,
    updated: '2026 edition',
    description: 'Guided practice exercises to build confidence with algebra, functions and geometry.',
  },
  {
    id: 'res-math-tg-10',
    title: 'Teacher Guide — Grade 10 Mathematics',
    type: 'Teacher Guide',
    grade: 10,
    subjectId: 'mathematics',
    pages: 130,
