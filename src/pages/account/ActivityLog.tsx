  ...
  return (
    <div className="space-y-6">
      <SectionHeading
        eyebrow="Security"
        title="Activity log"
        description="Every change to who can see what at your school — staff approvals, role changes, people joining or leaving, parent links, consent and weekly tests. Nobody can edit or delete these entries."
      />
      {loading ? (
