...
export function LearnerPractise() {
  ...
  const topics = topicsForSubject('mat-lit', demoLearner.grade)
  ...
  return (
    <div className="space-y-6">
      <SectionHeading
        ...
        description={`Grade ${demoLearner.grade} Mathematical Literacy — choose a topic and difficulty to begin.`}
      />
